...
-- Dumping data for table irdischarge.regras: ~9 rows (approximately)
...
INSERT INTO `regras` (`id`, `regrapai_id`, `conjunto_id`, `elemento_id`, `dataregra`, `ordem`, `previa`, `observacao`) VALUES
	...
	(6, 9, 2, 8, '2012-11-03 16:05:15', 1, '[V_INF][N_M_S][ADJ_M_S]', 'manter acompanhamento ambulatorial'),
	(7, 9, 2, 8, '2012-11-03 16:05:41', 2, '[V_INF][N_M_S][PRP]', 'manter uso de'),
	(8, NULL, 2, 8, '2012-11-03 16:06:19', 1, '[V_INF][PRP][N_M_S]', 'persistir em acompanhamento'),
	(9, NULL, 2, 8, '2012-11-03 16:07:17', 2, '[V_INF][N_M_S]', NULL);
...
-- Dumping data for table irdischarge.termosregras: ~23 rows (approximately)
